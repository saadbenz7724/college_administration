...
export class StudentsController {
    ...
    @Get(':studentId/with-class-attendance')
    getStudentAttendanceWithClass(@Param('studentId')studentId: number){
        return this.studentService.getStudentsWithClassAttendance(studentId);
    }
